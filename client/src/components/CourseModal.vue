    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content shadow-lg rounded-4">
        ...
        <div class="modal-body">
          <img
            :src="course.img || 'https://via.placeholder.com/800x400?text=No+Image'"
            alt="Course Image"
          ...
          <section>
            ...
            <div class="teetimes-list d-flex flex-wrap gap-3">
              ...
              <div
                v-for="teetime in teetimes"
                :key="teetime.time"
                class="card p-2 flex-grow-1"
              ...
              <!-- Replace above with your tee time cards in actual use -->
            </div>
          </section>
        </div>
      </div>
